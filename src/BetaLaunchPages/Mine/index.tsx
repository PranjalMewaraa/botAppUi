...
const AssetTokenizeCard:React.FC<MineCardAssetProps> = ({setAssetTokenizeDrawer}) => {
  ...
  return (
    <div
      ...
      onClick={handleClick}
    >
     <div className="w-full h-full flex flex-col gap-2  bg-slate-800 text-white rounded-xl p-2">
        <img src="https://images.pexels.com/photos/106399/pexels-photo-106399.jpeg" className="w-full rounded-2xl h-2/3 p-2" alt="" />
