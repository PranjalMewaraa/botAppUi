  ...
  return (
    <div className='w-full h-full flex p-4 items-center text-white' >
        <div className='h-3/4 w-full bg-slate-900 rounded-3xl p-4 flex flex-col items-center gap-4'>
            <h2 className='w-full text-center font-[ageo] text-3xl font-semibold'>HOUSE<span className='text-yellow-600'>DROP</span></h2>
            <img src={air} alt="" className='w-1/4'/>
            <h1 className='w-full text-center font-[ageo] text-xl font-semibold'>Something big is cooking up here</h1>
