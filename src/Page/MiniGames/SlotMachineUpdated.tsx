        ...
        <div className='flex flex-col p-4 mt-4 gap-4'>
          ...
          <div className='w-full p-4 bg-slate-800 rounded-lg text-white'>
            <ul className='w-full h-full flex flex-col gap-4'>
              <li> 1. Select a symbol - '🍒' | '🍋' | '🍊' | '🍉' | '🍇' </li>
              <li> 2. Spin to Win Rewards</li>
              <li>
                <div>
                  <span className='text-yellow-500'>Win System :</span>
                  <ul className='pl-4 list-disc'>
                    <li>Get all Rare 🍀 to Win Jackpot - 100K</li>
                    <li>Get 3 Any Symbol to win 100% of Max Bet</li>
                    <li>Get 2 Bet Symbol to Win 66% of Max Win</li>
                    <li>Get 1 Bet Symbol to Win 33% of Max Win</li>
                  </ul>
                </div>
              </li>
          ...
          <div className="flex flex-col gap-2 pt-2 px-2">
            ...
            <div className="flex gap-4 justify-center items-center font-[ageo]">
              ...
              <div className="flex flex-col items-center gap-1 rounded-lg">
                ...
                <div className="h-8 w-32 flex justify-center items-center bg-white border-yellow-300 border-2 gap-2 rounded-md text-black">
                  <span><img src="/images/coin.png" width={16} alt="" /></span>{Math.floor(user.balance)}
                </div>
              </div>
            </div>
          </div>
