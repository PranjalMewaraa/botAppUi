...
const TopNav: React.FC<TopNavProps> = ({ active, handleClick }) => {
  return (
    <div className="h-16 w-full p-2 mt-4 flex bg-slate-800 rounded-xl gap-2">
      <div
        className={`h-full w-1/2 text-white font-semibold flex justify-center items-center cursor-pointer ${
      ...
      {/* <div
        className={`h-full w-1/4 text-white font-semibold flex justify-center items-center cursor-pointer ${
      ...
      <div
        className={`h-full w-2/4 text-white font-semibold flex justify-center  items-center cursor-pointer ${
